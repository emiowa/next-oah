				...
				<div classNameName="container-fluid">
					<div className="row py-5 bg-dark">
							<div className="col-12 col-sm-12 col-lg-6 text-light px-5 paddingFooter">
								...
								<p className='fw-light'>El diseño es más importante y necesario de lo que creemos, un buen diseño puede afectar la vida, los hábitos, rutinas y emociones de las personas de una forma positiva.</p>
								<div className="d-flex flex-column">
									<p className='text-center fw-light'>Disfrutemos de la Arquitectura! Sígueme!</p>
						...
						<div className="text-center pt-2 my-1 fw-light">
