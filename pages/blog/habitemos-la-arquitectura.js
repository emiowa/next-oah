					...
					<div className='container-fluid mt-5 pt-4 mx-0 px-lg-5 vh-lg-100 mb-5'>
						<div className='row d-flex'>
							<div className="col-lg-6 ms-lg-5 textStyleResponsive">
								...
								<p className="paragraphStyle">El mundo está lleno de proyectos arquitectónicos impresionantes que con sólo ver fotografías de ellos es suficiente para maravillarnos. Sin embargo, la Arquitectura es mucho más que un edificio para ser admirado, la arquitectura es creada para ser habitada.<br /><br />
