					...
					<div className='container-fluid mt-5 pt-4 mx-0 px-lg-5 vh-lg-100 mb-5'>
						<div className='row d-flex'>
							<div className="col-lg-6 ms-lg-5 textStyleResponsive">
								...
								<p className="paragraphStyle">En mi diario vivir he encontrado situaciones que me han hecho preguntar y reflexionar sobre la forma en la que estamos diseñando nuestras ciudades ¿Estamos comprometidos con mejorar o seguimos cometiendo los mismos errores del pasado?<br /><br />
