...
export default function ComingSoon(){
	return (<div>
				...
				<div className='container-fluid mt-5 mx-0 px-lg-5 px-0 vh-100'>
					<div className='row'>
						<div>
							<h1 className="display-4 text-center mt-5">Great things are coming soon!</h1>
							<p className="text-center fs-4 mt-4 mt-lg-0" id="subtitleMobile">Emi is working hard to give you the best experience</p>
						</div>
