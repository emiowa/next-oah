						...
						<div className='row'>
							...
							<div className='col text-white me-5 pe-5 ms-5' id='containerMobile'>
								...
								<div className='vh-100 vw-auto d-flex flex-column justify-content-center'>
									<h2 className='fw-light display-6' id='titleH2Mobile'>User stories</h2>
								...
								<div className='vh-100 vw-auto d-flex flex-column justify-content-center'>
									<h2 className='fw-light display-6' id='titleH2Mobile'>Let's inhabit<br /> Architecture</h2>
								...
								<div className='vh-100 vw-auto d-flex flex-column justify-content-center'>
									<h2 className='fw-light display-6' id='titleH2Mobile'>Let's talk about<br /> Architecture</h2>
