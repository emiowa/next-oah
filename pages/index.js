						...
						<div className='row'>
							<div className='positionRelativeMobile'>
								...
								<div className='introText1'>
									<h1 className='display-1' id='titleHomeMobile1'>OAH<br />Architecture</h1>
									<p className='textCreatedBy1'>creado por Emi Owashi</p>
								</div>
							</div>
							<div className='col-6'></div>
							<div className='col text-white me-5 pe-5 ms-5' id='containerMobile'>
								<div className='vh-100 vw-auto d-xs-none d-lg-flex flex-column justify-content-lg-center justify-content-start align-items-lg-start align-items-end initialTextMobile'>
								...
								<div className='vh-100 vw-auto d-flex flex-column justify-content-center'>
									...
									<p className='fw-light' id='paragraphMobile'>Cuando el habitar un espacio se convierte en parte de tu rutina diaria, empiezas a identificar sus virtudes y defectos, empiezas a adquirir un gusto por pasar más tiempo en un área que en otra.</p>
								...
								<div className='vh-100 vw-auto d-flex flex-column justify-content-center'>
									...
									<p className='fw-light' id='paragraphMobile'>La Arquitectura es mucho más que un edificio para ser admirado, la arquitectura es creada para ser habitada.</p>
									<div className='mt-3 buttonMobile'>
								...
								<div className='vh-100 vw-auto d-flex flex-column justify-content-center'>
									...
									<p className='fw-light' id='paragraphMobile'>¿Cómo estamos diseñando nuestras ciudades? ¿Estamos comprometidos con mejorar o seguimos cometiendo los mismos errores del pasado?</p>
									<div className='mt-3 buttonMobile'>
